...
public class CourseListAdapter2 extends BaseAdapter {
    ...
    public CourseListAdapter2(ScheduleFragment fragment, Context context, List<Course> courseList, Fragment parent) {
    ...
    public View getView(final int i, View convertView, ViewGroup viewGroup) {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("courseIDList", courseIDList.toString() + "\n" + courseList.get(i).getCourseTime());
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (success) {
                                    ...
                                    fragment.new BackgroundTask().execute();
                                } else {
                                    AlertDialog.Builder builder = new AlertDialog.Builder(parent.getActivity());
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            try {
                target = "https://mnb9139.cafe24.com/ScheduleList.php?userID=" + URLEncoder.encode(userID, "UTF-8");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
